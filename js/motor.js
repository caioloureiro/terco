...
document
	.querySelector(".primeiro-misterio-gozoso .btn")
...
document
	.querySelector(".primeiro-misterio-luminoso .btn")
	.addEventListener("click", function () {
		document.querySelector(".escurecer").classList.remove("on");
...
document
	.querySelector(".primeiro-misterio-doloroso .btn")
	.addEventListener("click", function () {
		document.querySelector(".escurecer").classList.remove("on");
...
document
	.querySelector(".primeiro-misterio-glorioso .btn")
	.addEventListener("click", function () {
		document.querySelector(".escurecer").classList.remove("on");
...
/*Start - Pai Nosso*/
document
	.querySelector(".tela-pai-nosso .btn")
	.addEventListener("click", function () {
		document.querySelector(".escurecer").classList.remove("on");
...
document.querySelector(".trigger").addEventListener("click", function () {
	if (contador < total_itens) {
		...
		if (contador == 5) {
			...
			//document.querySelector('.intencoes').classList.add('on');
			if (string == "gozosos") {
				document.querySelector(".primeiro-misterio-gozoso").classList.add("on");
			}
			if (string == "luminosos") {
				document.querySelector(".primeiro-misterio-luminoso").classList.add("on");
			}
			if (string == "dolorosos") {
				document.querySelector(".primeiro-misterio-doloroso").classList.add("on");
			}
			if (string == "gloriosos") {
				document.querySelector(".primeiro-misterio-glorioso").classList.add("on");
			}
		...
		if (contador == 17) {
			...
			document.querySelector(".gloria").classList.add("on");
			if (string == "gozosos") {
				document.querySelector(".segundo-misterio-gozoso").classList.add("on");
			}
			if (string == "luminosos") {
				document.querySelector(".segundo-misterio-luminoso").classList.add("on");
			}
			if (string == "dolorosos") {
				document.querySelector(".segundo-misterio-doloroso").classList.add("on");
			}
			if (string == "gloriosos") {
				document.querySelector(".segundo-misterio-glorioso").classList.add("on");
			}
			document.querySelector(".tela-pai-nosso").classList.add("on");
		}
		if (contador == 28) {
			...
			document.querySelector(".gloria").classList.add("on");
			if (string == "gozosos") {
				document.querySelector(".terceiro-misterio-gozoso").classList.add("on");
			}
			if (string == "luminosos") {
				document.querySelector(".terceiro-misterio-luminoso").classList.add("on");
			}
			if (string == "dolorosos") {
				document.querySelector(".terceiro-misterio-doloroso").classList.add("on");
			}
			if (string == "gloriosos") {
				document.querySelector(".terceiro-misterio-glorioso").classList.add("on");
			}
			document.querySelector(".tela-pai-nosso").classList.add("on");
		}
		if (contador == 39) {
			...
			document.querySelector(".gloria").classList.add("on");
			if (string == "gozosos") {
				document.querySelector(".quarto-misterio-gozoso").classList.add("on");
			}
			if (string == "luminosos") {
				document.querySelector(".quarto-misterio-luminoso").classList.add("on");
			}
			if (string == "dolorosos") {
				document.querySelector(".quarto-misterio-doloroso").classList.add("on");
			}
			if (string == "gloriosos") {
				document.querySelector(".quarto-misterio-glorioso").classList.add("on");
			}
			document.querySelector(".tela-pai-nosso").classList.add("on");
		}
		if (contador == 50) {
			...
			document.querySelector(".gloria").classList.add("on");
			if (string == "gozosos") {
				document.querySelector(".quinto-misterio-gozoso").classList.add("on");
			}
			if (string == "luminosos") {
				document.querySelector(".quinto-misterio-luminoso").classList.add("on");
			}
			if (string == "dolorosos") {
				document.querySelector(".quinto-misterio-doloroso").classList.add("on");
			}
			if (string == "gloriosos") {
				document.querySelector(".quinto-misterio-glorioso").classList.add("on");
			}
			document.querySelector(".tela-pai-nosso").classList.add("on");
		}
		if (contador == 61) {
...
/*Start - Agradecimento*/
document
	.querySelector(".agradecimento .btn")
	.addEventListener("click", function () {
...
/*Start - Salve Rainha*/
document
	.querySelector(".salve-rainha .btn")
	.addEventListener("click", function () {
...
/*Start - Escutar*/
function escutar() {
	window.location.href = "terco-lido";
}
/*End - Escutar*/
